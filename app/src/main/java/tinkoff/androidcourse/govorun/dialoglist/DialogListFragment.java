...
import static tinkoff.androidcourse.govorun.Constants.KEY_DIALOG_DESCRIPTION;
import static tinkoff.androidcourse.govorun.Constants.KEY_DIALOG_TITLE;
    ...
    public void onAttach(Context context) {
        ...
        if (!(activity instanceof DialogListListener)) {
            throw new IllegalStateException(
                    "Activity does not implement tinkoff.androidcourse.govorun.dialoglist.DialogListFragment.DialogListListener");
        }
